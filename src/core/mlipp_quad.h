#ifndef __MLIPP_QUAD_H__
#define __MLIPP_QUAD_H__
...
class MLIPP_QUAD
{
    static_assert(std::is_arithmetic<T>::value, "MLIPP_QUAD key type must be numeric.");
...
public:
    ...
    MLIPP_QUAD(double BUILD_LR_REMAIN = 0, bool QUIET = true)
